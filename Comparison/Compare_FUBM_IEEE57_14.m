...
[MVAbase, bus,gen, branch, success, et, time_fubm, Ybus, iter_fubm] = runpf('IEEE_57_14_HVDC_fubm'); 
...
% NOTE 
% The following network has 2 interfacing converters that operate in
% Vdc-mode. We can see that the FUBM-base method does not converge:
%[MVAbase, bus,gen, branch, success, et, time_fubm, Ybus, iter_fubm] = runpf('IEEE_57_14_HVDC'); 

%% Proposed method (EPFL)

mpc = loadcase('IEEE_57_14_HVDC_fubm'); 

% NOTE 
% The following network has 2 interfacing converters that operate in
% Vdc-mode. We can see that the proposed method does converge:
